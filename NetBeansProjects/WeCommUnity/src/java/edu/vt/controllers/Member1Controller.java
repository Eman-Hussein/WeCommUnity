...
import edu.vt.FacadeBeans.Member1Facade;
...
public class Member1Controller implements Serializable {
    ...
    @EJB
    private edu.vt.FacadeBeans.Member1Facade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("Member1Created"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("Member1Updated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("Member1Deleted"));
        if (!JsfUtil.isValidationFailed()) {
