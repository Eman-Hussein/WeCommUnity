...
public class UserController implements Serializable {
    ...
    /*
    The instance variable 'userContnentFacade' is annotated with the @EJB annotation.
    The @EJB annotation directs the EJB Container (of the GlassFish AS) to inject (store) the object reference 
    of the UserContnentFacade object, after it is instantiated at runtime, into the instance variable 'userFileFacade'.
     */
    @EJB
    private UserContentFacade userContentFacade;
    ...
    public UserContentFacade getUserContentFacade() {
        return userContentFacade;
    }

    public void setUserContentFacade(UserContentFacade userContentFacade) {
        this.userContentFacade = userContentFacade;
    }
    ...
    **********************************
    ...
    /* **********************************
    Return True if an Adminstrator is Signed In
    **********************************
     */
    public boolean isAdministrator() {
        String userName = (String) Methods.sessionMap().get("username");
        if (userName != null) {
    ...
    ***********************************************
    ...
    public void deleteAllUserFiles(int primaryKey) {
        ...
        List<UserContent> userFilesList = getUserContentFacade().findUserContentByUserPrimaryKey(primaryKey);
        ...
        if (!userFilesList.isEmpty()) {
            ...
            userFilesList.forEach(userFile -> {
                try {
                    ...
                    getUserContentFacade().remove(userFile);
